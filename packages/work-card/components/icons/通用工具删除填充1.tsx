...
// ── 通用工具删除填充1（删除填充图标，无 mask 版本）──────────────────────────────────
// 来源：icon/通用工具-删除-填充-1.svg
export const 通用工具删除填充1 = React.forwardRef<SVGSVGElement, IconProps>(
  function 通用工具删除填充1({ size = 48, className, style, ...props }, ref) {
    return (
      <svg
        width={size}
        height={size}
...
通用工具删除填充1.displayName = "通用工具删除填充1";
