...
// ── 大模型-文字提取 ──────────────────────────────────────────────
// 来源：icon/大模型-文字提取.svg
export const 大模型文字提取 = React.forwardRef<SVGSVGElement, IconProps>(
  function 大模型文字提取({ size = 48, className, style, ...props }, ref) {
